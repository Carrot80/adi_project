...
%     tdislike_vs_dontcare_all =[];
 ...
 %% like vs. dislike
    ...
    for i = 1:length(list)   
           path2SVMresult = ([subjpath list(i).name '\EEG_analysis\1_45Hz\04_timelockstatistics_interp\']); 
...
%  legend(Name)
 ...
 close 
    ...
    figure
    [ph, msg] = jbfill(time, std_Accuracy_pos, std_Accuracy_neg, 'blue', [0.1, 0.1, 0.1],1, 0.2)
    hold on
