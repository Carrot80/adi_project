 ...
 [sessions] = concatenate_sessions(sessions, freqname, outPath_extdisc);
...
function [sessions_all_freqs] = concatenate_sessions(sessions, freqname, outPath_extdisc)
...
%   save ([outPath_extdisc 'MEG\sourcespace\runs_appended\virtsens\' cfg_virtsens '_' condition '_allRuns_', freqname, '.mat'], 'vs_allRuns', '-v7.3');
...
if ~exist([outPath 'virtsens_all_conditions_allRuns_', freqname, '.mat'], 'file')   
    vs_allRuns = [];
    spatialfilter = {};
