...
if ~exist([outPath_extdisc 'MEG\sourcespace\allRois\run2\vs_mean_all_rois_' dislike '_' freqbandname '.mat'], 'file')
...
if ~exist([outPath_extdisc 'MEG\sourcespace\allRois\run3\vs_mean_all_rois_' dislike '_' freqbandname '.mat'], 'file')
...
if exist ('vs_euclid_roi_like_all', 'var')
    ...
    save ([outPath_extdisc 'run' run '\vs_max_all_rois_like_' freq], 'max_all_rois_like')
    [mean_all_rois_like] =  extract_mean_max(vs_euclid_roi_like_all, 'mean', atlas_downsampled2source_avg.tissuelabel); 
    save ([outPath_extdisc 'run' run '\vs_mean_all_rois_like_' freq], 'mean_all_rois_like')
end
if exist ('vs_euclid_roi_dislike_all', 'var')
    ...
    save ([outPath_extdisc 'run' run '\vs_max_all_rois_dislike_' freq], 'max_all_rois_dislike')
    [mean_all_rois_dislike] =  extract_mean_max(vs_euclid_roi_dislike_all, 'mean', atlas_downsampled2source_avg.tissuelabel); 
    save ([outPath_extdisc 'run' run '\vs_mean_all_rois_dislike_' freq], 'mean_all_rois_dislike')
end
if exist ('vs_euclid_roi_dontcare_all', 'var')
    ...
    save ([outPath_extdisc 'run' run '\vs_mean_all_rois_dontcare_' freq], 'mean_all_rois_dontcare')
    [max_all_rois_dontcare] =  extract_mean_max(vs_euclid_roi_dontcare_all, 'max', atlas_downsampled2source_avg.tissuelabel); 
    save ([outPath_extdisc 'run' run '\vs_max_all_rois_dontcare_' freq], 'max_all_rois_dontcare')
end
