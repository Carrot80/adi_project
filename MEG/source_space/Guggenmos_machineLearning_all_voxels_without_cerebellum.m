 ...
 function []= main(path2data, outPath_extdisc, freqname, condition, atlas)

 [session] = mk_SVM_struct([], path2data, outPath_extdisc, freqname, condition);
 SVM_Guggenmos_tutorial(session, outPath_extdisc, freqname, condition, atlas)
 
%   save ([outPath 'MEG\sourcespace\runs_appended\virtsens\' cfg_virtsens '_' condition '_allRuns_', freqname, '.mat'], 'vs_allRuns', '-v7.3');
 end
 
 
 function [session] = mk_SVM_struct(session, path2data, outPath_extdisc, freqname, condition, atlas)
