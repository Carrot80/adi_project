function stats(like_training, dislike_training, time)
...
stat = ft_timelockstatistics(cfg, like_training, dislike_training);
...
mv_plot_result(stat.mvpa, session_sorted.time{1})
