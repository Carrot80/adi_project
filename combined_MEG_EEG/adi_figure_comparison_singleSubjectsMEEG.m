...
%     tdislike_vs_dontcare_all =[];
 ...
 %% like vs. dislike
    ...
    for i = 1:length(list)   
           path2SVMresult = ([subjpath list(i).name '\combined_MEG_EEG_analysis\02c_statistics_allRuns\']); 
...
%  legend(Name)
 ...
 close 
    ...
    figure
    [ph, msg] = jbfill(time, std_Accuracy_pos, std_Accuracy_neg, 'red', [0.1, 0.1, 0.1],1, 0.2)
    hold on
