function adi_select_files (inpath, outpath, run)
    ...
    save ([outpath, filesep, 'dislike500_', run, '.mat'], 'RetVal');
    clear RetVal;
    ...
    save ([outpath, filesep, 'like500_', run, '.mat'], 'RetVal');
    clear RetVal;
    ...
    if ~isempty(ListDontcare) 
        ...
        save ([outpath, filesep, 'dontcare500_', run, '.mat'], 'RetVal');
        clear RetVal
    end
