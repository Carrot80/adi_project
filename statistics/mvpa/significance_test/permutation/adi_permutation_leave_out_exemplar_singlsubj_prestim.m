...
%     perm_rwv = perf_perm.rwv;
    ...
    if ~exist(['E:\adidas\fieldtrip_Auswertung\single_subjects\' subjectdir(ii).name filesep 'MEG\mvpa\significance_testing_prestim'], 'dir')
        mkdir(['E:\adidas\fieldtrip_Auswertung\single_subjects\' subjectdir(ii).name filesep 'MEG\mvpa\significance_prestim'])
    end
    save(['E:\adidas\fieldtrip_Auswertung\single_subjects\' subjectdir(ii).name filesep 'MEG\mvpa\significance_prestim\performance_real_data.mat'], 'perf')
%     save(['E:\adidas\fieldtrip_Auswertung\single_subjects\' subjectdir(ii).name filesep 'MEG\mvpa\significance_testing\performance_permutation_null_distribution_gbf_prestim.mat'], 'perm_gbf')
    save(['E:\adidas\fieldtrip_Auswertung\single_subjects\' subjectdir(ii).name filesep 'MEG\mvpa\significance_prestim\performance_permutation_null_distribution_gbs_prestim.mat'], 'perm_gbs')
